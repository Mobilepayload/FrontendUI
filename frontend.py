...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.label_2.grid(row=4, column=0, columnspan=2, pady=0, padx=0, sticky="we")
        ...
        self.label_info_3 = customtkinter.CTkLabel(master=self.frame_right,
                                                   text="Velocity Info\n\nLinear Velocity: "+self.X+"m/s\nAngular Velocity: "+self.Z+"rad/s",
                                                   height=100,
                                                   fg_color=("white", "gray38"),  # <- custom tuple-color
                                                   justify=tkinter.CENTER)
        self.label_info_3.grid(column=1, row=8, sticky="nwe", padx=15, pady=15)


        self.sync_button_1 = customtkinter.CTkButton(master=self.frame_right,
                                                       height=100,
                                                       width=40,
                                                       text="Sync",
                                                       command=self.update)
        self.sync_button_1.grid(row=8, column=2, columnspan=2, pady=10, padx=20, sticky="we")
